...
public class ConnectFourGUI {
   ...
   /**
    * arrays containing the graphic file represnting the player pieces:
    * "images/player1.jpg" & "images/player1.jpg"
    */
    ...
    * 
    * @param player the player (number starting at 1) of the next player; its
    *               corresponding icon will be displayed under "Next Turn"
    */
